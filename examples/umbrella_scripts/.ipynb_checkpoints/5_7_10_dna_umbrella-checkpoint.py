...
com_lists = [
    ...
    '14503,10515,10516,10517,10518,10519,10520,10521,10522,10523,10524,22016,22015,22014,22013,22012,22011,22010,22009,22008,22007',
...
production_parameters = {'dt':f'0.002', 'steps':'1e6','print_energy_every': '5e5','print_conf_interval':'5e5', 'fix_diffusion':'false'}
